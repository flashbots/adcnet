...
> Do use this repository if you want to familiarize yourself with DCNet/ZIPNet and/or experiment with the protocol 💖
...
sequenceDiagram
    ...
    rect rgb(240, 255, 240)
        ...
        S->>L: Aggregate unblinding vectors (decryption share)
    end
