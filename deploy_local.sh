...
echo "║                                                               ║"
echo "║  Send a message:                                              "
echo "║    go run ./cmd/demo-cli send -r ${REGISTRY_URL} -m 'Hello ADCNet!' -b 100 --skip-verification"
echo "║                                                               "
echo "║  Monitor rounds (CLI):                                        "
echo "║    go run ./cmd/demo-cli monitor -r ${REGISTRY_URL} --follow --skip-verification"
echo "║                                                               "
echo "║  Check status:                                                ║"
